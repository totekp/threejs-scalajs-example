...
/** @constructor */
ScalaJS.c.Luser_totekp_threejs_ExampleApp$ = (function() {
  ScalaJS.c.O.call(this)
});
ScalaJS.c.Luser_totekp_threejs_ExampleApp$.prototype = new ScalaJS.h.O();
ScalaJS.c.Luser_totekp_threejs_ExampleApp$.prototype.constructor = ScalaJS.c.Luser_totekp_threejs_ExampleApp$;
/** @constructor */
ScalaJS.h.Luser_totekp_threejs_ExampleApp$ = (function() {
  /*<skip>*/
});
ScalaJS.h.Luser_totekp_threejs_ExampleApp$.prototype = ScalaJS.c.Luser_totekp_threejs_ExampleApp$.prototype;
ScalaJS.c.Luser_totekp_threejs_ExampleApp$.prototype.init___ = (function() {
  ScalaJS.n.Luser_totekp_threejs_ExampleApp = this;
  return this
});
ScalaJS.c.Luser_totekp_threejs_ExampleApp$.prototype.createCube$1__p1__D__Luser_totekp_threejs_THREE$Mesh = (function(side) {
  var geometry = new ScalaJS.g["THREE"]["BoxGeometry"](side, side, side);
  var material = new ScalaJS.g["THREE"]["MeshBasicMaterial"]({
    "color": 65280,
    "wireframe": true
  });
  var cube = new ScalaJS.g["THREE"]["Mesh"](geometry, material);
  return cube
});
ScalaJS.c.Luser_totekp_threejs_ExampleApp$.prototype.user$totekp$threejs$ExampleApp$$renderLoop$1__D__Luser_totekp_threejs_THREE$Scene__Luser_totekp_threejs_THREE$PerspectiveCamera__Luser_totekp_threejs_THREE$WebGLRenderer__Luser_totekp_threejs_THREE$Mesh__V = (function(timestamp, scene$1, camera$1, renderer$1, cube$1) {
  ScalaJS.uI(ScalaJS.g["requestAnimationFrame"]((function(scene$1$1, camera$1$1, renderer$1$1, cube$1$1) {
    return (function(timestamp$2) {
      var timestamp$1 = ScalaJS.uD(timestamp$2);
      ScalaJS.m.Luser_totekp_threejs_ExampleApp().user$totekp$threejs$ExampleApp$$renderLoop$1__D__Luser_totekp_threejs_THREE$Scene__Luser_totekp_threejs_THREE$PerspectiveCamera__Luser_totekp_threejs_THREE$WebGLRenderer__Luser_totekp_threejs_THREE$Mesh__V(timestamp$1, scene$1$1, camera$1$1, renderer$1$1, cube$1$1)
    })
  })(scene$1, camera$1, renderer$1, cube$1)));
  var ev$1 = cube$1["rotation"];
  ev$1["x"] = (ScalaJS.uD(ev$1["x"]) + 0.1);
  var ev$2 = cube$1["rotation"];
  ev$2["y"] = (ScalaJS.uD(ev$2["y"]) + 0.1);
  renderer$1["render"](scene$1, camera$1)
});
ScalaJS.c.Luser_totekp_threejs_ExampleApp$.prototype.main__V = (function() {
  var scene = new ScalaJS.g["THREE"]["Scene"]();
  var camera = new ScalaJS.g["THREE"]["PerspectiveCamera"](75.0, (ScalaJS.uI(ScalaJS.g["window"]["innerWidth"]) / ScalaJS.uI(ScalaJS.g["window"]["innerHeight"])), 0.1, 1000.0);
  var renderer = new ScalaJS.g["THREE"]["WebGLRenderer"]({});
  ScalaJS.g["document"]["body"]["appendChild"](renderer["domElement"]);
  renderer["setSize"](ScalaJS.uI(ScalaJS.g["window"]["innerWidth"]), ScalaJS.uI(ScalaJS.g["window"]["innerHeight"]));
  camera["position"]["z"] = 5.0;
  var cube = this.createCube$1__p1__D__Luser_totekp_threejs_THREE$Mesh(3.0);
  scene["add"](cube);
  this.user$totekp$threejs$ExampleApp$$renderLoop$1__D__Luser_totekp_threejs_THREE$Scene__Luser_totekp_threejs_THREE$PerspectiveCamera__Luser_totekp_threejs_THREE$WebGLRenderer__Luser_totekp_threejs_THREE$Mesh__V(ScalaJS.m.jl_System().currentTimeMillis__J().toDouble__D(), scene, camera, renderer, cube)
});
ScalaJS.c.Luser_totekp_threejs_ExampleApp$.prototype.$$js$exported$meth$main__O = (function() {
  return (this.main__V(), (void 0))
});
ScalaJS.c.Luser_totekp_threejs_ExampleApp$.prototype["main"] = (function() {
  return this.$$js$exported$meth$main__O()
});
ScalaJS.is.Luser_totekp_threejs_ExampleApp$ = (function(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Luser_totekp_threejs_ExampleApp$)))
});
ScalaJS.as.Luser_totekp_threejs_ExampleApp$ = (function(obj) {
  return ((ScalaJS.is.Luser_totekp_threejs_ExampleApp$(obj) || (obj === null)) ? obj : ScalaJS.throwClassCastException(obj, "user.totekp.threejs.ExampleApp$"))
});
ScalaJS.isArrayOf.Luser_totekp_threejs_ExampleApp$ = (function(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Luser_totekp_threejs_ExampleApp$)))
});
ScalaJS.asArrayOf.Luser_totekp_threejs_ExampleApp$ = (function(obj, depth) {
  return ((ScalaJS.isArrayOf.Luser_totekp_threejs_ExampleApp$(obj, depth) || (obj === null)) ? obj : ScalaJS.throwArrayCastException(obj, "Luser.totekp.threejs.ExampleApp$;", depth))
});
ScalaJS.d.Luser_totekp_threejs_ExampleApp$ = new ScalaJS.ClassTypeData({
  Luser_totekp_threejs_ExampleApp$: 0
}, false, "user.totekp.threejs.ExampleApp$", ScalaJS.d.O, {
  Luser_totekp_threejs_ExampleApp$: 1,
  sjs_js_JSApp: 1,
  O: 1
});
ScalaJS.c.Luser_totekp_threejs_ExampleApp$.prototype.$classData = ScalaJS.d.Luser_totekp_threejs_ExampleApp$;
ScalaJS.n.Luser_totekp_threejs_ExampleApp = (void 0);
ScalaJS.m.Luser_totekp_threejs_ExampleApp = (function() {
  if ((!ScalaJS.n.Luser_totekp_threejs_ExampleApp)) {
    ScalaJS.n.Luser_totekp_threejs_ExampleApp = new ScalaJS.c.Luser_totekp_threejs_ExampleApp$().init___()
  };
  return ScalaJS.n.Luser_totekp_threejs_ExampleApp
});
ScalaJS.e["user"] = (ScalaJS.e["user"] || {});
ScalaJS.e["user"]["totekp"] = (ScalaJS.e["user"]["totekp"] || {});
ScalaJS.e["user"]["totekp"]["threejs"] = (ScalaJS.e["user"]["totekp"]["threejs"] || {});
ScalaJS.e["user"]["totekp"]["threejs"]["ExampleApp"] = ScalaJS.m.Luser_totekp_threejs_ExampleApp;
...
ScalaJS.c.jl_System$.prototype.currentTimeMillis__J = (function() {
  var value = ScalaJS.uD(new ScalaJS.g["Date"]()["getTime"]());
  return ScalaJS.m.sjsr_RuntimeLongImpl().fromDouble__D__sjsr_RuntimeLong(value)
});
...
//# sourceMappingURL=threejs-scalajs-example-fastopt.js.map
